package com.example.acelanandroid.opengl.model

import android.opengl.GLES20
import android.util.Log
import androidx.annotation.RawRes
import com.example.acelanandroid.MainActivityHiltApp
...
object Util {
    ...
    private val densityScalar: Float
        get() = MainActivityHiltApp.instance.resources.displayMetrics.density
    ...
    private fun readTextFileFromRawRes(@RawRes resourceId: Int): String {
        val inputStream = MainActivityHiltApp.instance.resources.openRawResource(resourceId)
        try {
